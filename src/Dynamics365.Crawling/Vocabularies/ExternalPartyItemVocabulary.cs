...
{
    public class ExternalPartyItemVocabulary : SimpleVocabulary
    {
        public ExternalPartyItemVocabulary()
        {
            VocabularyName = "Dynamics365 ExternalPartyItem";
            KeyPrefix = "dynamics365.externalpartyitem";
            KeySeparator = ".";
            Grouping = EntityType.Unknown; // TODO: Set value

            this.AddGroup("ExternalPartyItem", group =>
            {
                this.ExternalPartyId = group.Add(new VocabularyKey("ExternalPartyId", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"Type the external party record that this item is created for.")
                    .WithDisplayName("External Party")
                    .ModelProperty("externalpartyid", typeof(string)));
                ...
                this.LastEnabledOn = group.Add(new VocabularyKey("LastEnabledOn", VocabularyKeyDataType.DateTime, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"Shows the date and time when the external party item was last enabled for external channel access.")
                ...
                this.LastDisabledOn = group.Add(new VocabularyKey("LastDisabledOn", VocabularyKeyDataType.DateTime, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"Shows the date and time when the external party item was last disabled for external channel access.")
                    .WithDisplayName("Last Disabled On")
                    .ModelProperty("lastdisabledon", typeof(DateTime)));

                this.StateCode = group.Add(new VocabularyKey("StateCode", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"Shows whether the external party item is enabled or disabled.")
                    .WithDisplayName("Status")
                    .ModelProperty("statecode", typeof(string)));

                this.StatusCode = group.Add(new VocabularyKey("StatusCode", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"Select the external party items status.")
                    .WithDisplayName("Status Reason")
                    .ModelProperty("statuscode", typeof(string)));

                this.ChannelAccessProfileId = group.Add(new VocabularyKey("ChannelAccessProfileId", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"Choose the channel access profile that's used to determine the permissions when CRM is accessed from an external channel.")
                    .WithDisplayName("Channel Access Profile")
                    .ModelProperty("channelaccessprofileid", typeof(string)));
                ...
                this.ChannelAccessProfileIdName = group.Add(new VocabularyKey("ChannelAccessProfileIdName", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable(), k => k.MaxLength(100))
                    .WithDescription(@"")
                    .WithDisplayName("ChannelAccessProfileIdName")
                    .ModelProperty("channelaccessprofileidname", typeof(string)));

                this.Name = group.Add(new VocabularyKey("Name", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable(), k => k.MaxLength(300))
                    .WithDescription(@"Type the name of the external party item.")
                    .WithDisplayName("Name")
                    .ModelProperty("name", typeof(string)));

                this.ExternalPartyIdName = group.Add(new VocabularyKey("ExternalPartyIdName", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable(), k => k.MaxLength(100))
                    .WithDescription(@"")
                    .WithDisplayName("ExternalPartyIdName")
                    .ModelProperty("externalpartyidname", typeof(string)));

                this.ExternalPartyItemId = group.Add(new VocabularyKey("ExternalPartyItemId", VocabularyKeyDataType.Guid, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"Unique identifier for external party instances")
                    .WithDisplayName("External Party Item")
                    .ModelProperty("externalpartyitemid", typeof(Guid)));

                this.TransactionCurrencyId = group.Add(new VocabularyKey("TransactionCurrencyId", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"Exchange rate for the currency associated with the ExternalPartyItem with respect to the base currency.")
                ...
                this.RegardingObjectId = group.Add(new VocabularyKey("RegardingObjectId", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"Choose the external party enabled record that is associated with this external party item.")
                ...
                this.RegardingObjectIdName = group.Add(new VocabularyKey("RegardingObjectIdName", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    ...
                    .WithDescription(@"Shows the name of the regarding object.")
                ...
                this.RegardingObjectIdYomiName = group.Add(new VocabularyKey("RegardingObjectIdYomiName", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable(), k => k.MaxLength(400))
                    .WithDescription(@"Shows the name of the regarding object.")
                    .WithDisplayName("Regarding object yomi name")
                ...
                this.RegardingObjectTypeCode = group.Add(new VocabularyKey("RegardingObjectTypeCode", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"Shows the regarding object type.")
                ...
                this.ExchangeRate = group.Add(new VocabularyKey("ExchangeRate", VocabularyKeyDataType.Number, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Exchange rate for the currency associated with the external party item with respect to the base currency.")
        ...
        public VocabularyKey ChannelAccessProfileIdName { get; private set; }

        public VocabularyKey Name { get; private set; }

        public VocabularyKey ExternalPartyIdName { get; private set; }

        public VocabularyKey ExternalPartyItemId { get; private set; }
