...
{
    public class CustomControlResourceVocabulary : SimpleVocabulary
    {
        public CustomControlResourceVocabulary()
        {
            VocabularyName = "Dynamics365 CustomControlResource";
            KeyPrefix = "dynamics365.customcontrolresource";
            KeySeparator = ".";
            Grouping = EntityType.Unknown; // TODO: Set value

            this.AddGroup("CustomControlResource", group =>
            {
                this.CustomControlResourceId = group.Add(new VocabularyKey("CustomControlResourceId", VocabularyKeyDataType.Guid, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Unique identifier of the Custom Control Resource.")
                    .WithDisplayName("Custom Control Resource Id")
                    .ModelProperty("customcontrolresourceid", typeof(Guid)));
                ...
                this.CustomControlId = group.Add(new VocabularyKey("CustomControlId", VocabularyKeyDataType.Guid, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Unique identifier of the custom control.")
                ...
                this.Name = group.Add(new VocabularyKey("Name", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    ...
                    .WithDescription(@"Name of the custom control resource.")
                ...
                this.Version = group.Add(new VocabularyKey("Version", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    ...
                    .WithDisplayName("Custom Control Resource Version")
                    .ModelProperty("version", typeof(string)));

                this.VersionRequirement = group.Add(new VocabularyKey("VersionRequirement", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable(), k => k.MaxLength(40))
                    .WithDescription(@"For internal use only.")
                    .WithDisplayName("Custom Control Resource Version Requirement")
                    .ModelProperty("versionrequirement", typeof(string)));
                ...
                this.VersionNumber = group.Add(new VocabularyKey("VersionNumber", VocabularyKeyDataType.Integer, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Version number of the Custom Control Resource.")
                ...
                this.CustomControlResourceIdUnique = group.Add(new VocabularyKey("CustomControlResourceIdUnique", VocabularyKeyDataType.Guid, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"For internal use only.")
                    .WithDisplayName("CustomControlResourceIdUnique")
                    .ModelProperty("customcontrolresourceidunique", typeof(Guid)));
        ...
        public VocabularyKey CustomControlResourceId { get; private set; }
        ...
        public VocabularyKey VersionRequirement { get; private set; }
        ...
        public VocabularyKey CustomControlResourceIdUnique { get; private set; }
