...
namespace CluedIn.Crawling.Dynamics365.Vocabularies
{
    public class CategoryVocabulary : SimpleVocabulary
    {
        ...
        {
            VocabularyName = "Dynamics365 Category";
            KeyPrefix = "dynamics365.category";
            KeySeparator = ".";
            Grouping = EntityType.Unknown; // TODO: Set value

            this.AddGroup("Category", group =>
            {
                this.CategoryId = group.Add(new VocabularyKey("CategoryId", VocabularyKeyDataType.Guid, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Shows the category.")
                    .WithDisplayName("Category ID")
                    .ModelProperty("categoryid", typeof(Guid)));

                this.Description = group.Add(new VocabularyKey("Description", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable(), k => k.MaxLength(2000))
                    .WithDescription(@"Type a detailed description of the category")
                ...
                this.SequenceNumber = group.Add(new VocabularyKey("SequenceNumber", VocabularyKeyDataType.Integer, VocabularyKeyVisibility.Visible)
                    ...
                    .WithDescription(@"Enter a number to define the display position of the category in the hierarchy.")
                    .WithDisplayName("Display Order")
                    .ModelProperty("sequencenumber", typeof(long)));

                this.ParentCategoryId = group.Add(new VocabularyKey("ParentCategoryId", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"Select an existing category article for the category.")
                    .WithDisplayName("Parent Category")
                    .ModelProperty("parentcategoryid", typeof(string)));
                ...
                this.Title = group.Add(new VocabularyKey("Title", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    ...
                    .WithDescription(@"Type a title for the Category.")
                ...
                this.OwningUser = group.Add(new VocabularyKey("OwningUser", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Unique identifier of the user who owns this category.")
                ...
                this.ParentCategoryIdName = group.Add(new VocabularyKey("ParentCategoryIdName", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit(), k => k.MaxLength(100))
                    .WithDescription(@"")
                    .WithDisplayName("ParentCategoryIdName")
                    .ModelProperty("parentcategoryidname", typeof(string)));

                this.CategoryNumber = group.Add(new VocabularyKey("CategoryNumber", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable(), k => k.MaxLength(4000))
                    .WithDescription(@"Shows the category number for customer reference.")
                    .WithDisplayName("Category Number")
                    .ModelProperty("categorynumber", typeof(string)));
        ...
        public VocabularyKey ParentCategoryId { get; private set; }
        ...
        public VocabularyKey ParentCategoryIdName { get; private set; }

        public VocabularyKey CategoryNumber { get; private set; }
