...
{
    public class ImportEntityMappingVocabulary : SimpleVocabulary
    {
        public ImportEntityMappingVocabulary()
        {
            VocabularyName = "Dynamics365 ImportEntityMapping";
            KeyPrefix = "dynamics365.importentitymapping";
            KeySeparator = ".";
            Grouping = EntityType.Unknown; // TODO: Set value

            this.AddGroup("ImportEntityMapping", group =>
            {
                this.ImportEntityMappingId = group.Add(new VocabularyKey("ImportEntityMappingId", VocabularyKeyDataType.Guid, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Unique identifier of the import entity mapping.")
                    .WithDisplayName("ImportEntityMappingId")
                    .ModelProperty("importentitymappingid", typeof(Guid)));

                this.CreatedBy = group.Add(new VocabularyKey("CreatedBy", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Unique identifier of the user who created the import entity mapping.")
                ...
                this.TargetEntityName = group.Add(new VocabularyKey("TargetEntityName", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    ...
                    .WithDescription(@"Name of the Microsoft Dynamics 365 entity.")
                    .WithDisplayName("Target Entity")
                    .ModelProperty("targetentityname", typeof(string)));

                this.StatusCode = group.Add(new VocabularyKey("StatusCode", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"Reason for the status of the import entity mapping.")
                ...
                this.ProcessCode = group.Add(new VocabularyKey("ProcessCode", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"Information about whether the import entity mapping needs to be processed.")
                    .WithDisplayName("Process Code")
                    .ModelProperty("processcode", typeof(string)));

                this.ModifiedOn = group.Add(new VocabularyKey("ModifiedOn", VocabularyKeyDataType.DateTime, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Date and time when the import entity mapping was last modified.")
                    .WithDisplayName("Modified On")
                    .ModelProperty("modifiedon", typeof(DateTime)));

                this.DeDupeName = group.Add(new VocabularyKey("DeDupeName", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Name for Dedupe")
                    .WithDisplayName("DeDupeName")
                    .ModelProperty("dedupename", typeof(string)));

                this.CreatedOn = group.Add(new VocabularyKey("CreatedOn", VocabularyKeyDataType.DateTime, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Date and time when the import entity mapping was created.")
                ...
                this.ImportMapId = group.Add(new VocabularyKey("ImportMapId", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"Unique identifier of the associated data map.")
                    .WithDisplayName("Data Map ID")
                    .ModelProperty("importmapid", typeof(string)));

                this.DeDupe = group.Add(new VocabularyKey("DeDupe", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"Information about whether the entity needs to be processed to find and delete duplicate records.")
                    .WithDisplayName("Remove Duplicates")
                    .ModelProperty("dedupe", typeof(string)));
                ...
                this.SourceEntityName = group.Add(new VocabularyKey("SourceEntityName", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable(), k => k.MaxLength(160))
                    .WithDescription(@"Name of the source entity.")
                    .WithDisplayName("Source Entity Name")
                    .ModelProperty("sourceentityname", typeof(string)));

                this.ModifiedBy = group.Add(new VocabularyKey("ModifiedBy", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Unique identifier of the user who last modified the import entity mapping.")
                    .WithDisplayName("Modified By")
                    .ModelProperty("modifiedby", typeof(string)));

                this.StateCode = group.Add(new VocabularyKey("StateCode", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Status of the import entity mapping.")
                ...
                this.ImportMapIdName = group.Add(new VocabularyKey("ImportMapIdName", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit(), k => k.MaxLength(100))
                    .WithDescription(@"Name of the associated data map.")
                    .WithDisplayName("Data Map")
                    .ModelProperty("importmapidname", typeof(string)));

                this.StateCodeName = group.Add(new VocabularyKey("StateCodeName", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Status name of the import entity mapping.")
                    .WithDisplayName("StateCodeName")
                    .ModelProperty("statecodename", typeof(string)));

                this.StatusCodeName = group.Add(new VocabularyKey("StatusCodeName", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Name of the status reason of the import entity mapping.")
                ...
                this.CreatedOnBehalfBy = group.Add(new VocabularyKey("CreatedOnBehalfBy", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Unique identifier of the delegate user who created the importentitymapping.")
                ...
                this.ModifiedOnBehalfBy = group.Add(new VocabularyKey("ModifiedOnBehalfBy", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Unique identifier of the delegate user who last modified the importentitymapping.")
                ...
                this.ImportEntityMappingIdUnique = group.Add(new VocabularyKey("ImportEntityMappingIdUnique", VocabularyKeyDataType.Guid, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Unique identifier of the Import Entity Mapping.")
                    .WithDisplayName("ImportEntityMappingIdUnique")
                    .ModelProperty("importentitymappingidunique", typeof(Guid)));
        ...
        public VocabularyKey ImportEntityMappingId { get; private set; }
        ...
        public VocabularyKey DeDupeName { get; private set; }

        public VocabularyKey CreatedOn { get; private set; }

        public VocabularyKey ImportMapId { get; private set; }

        public VocabularyKey DeDupe { get; private set; }
        ...
        public VocabularyKey ImportEntityMappingIdUnique { get; private set; }
