...
{
    public class ConvertRuleItemVocabulary : SimpleVocabulary
    {
        public ConvertRuleItemVocabulary()
        {
            VocabularyName = "Dynamics365 ConvertRuleItem";
            KeyPrefix = "dynamics365.convertruleitem";
            KeySeparator = ".";
            Grouping = EntityType.Unknown; // TODO: Set value

            this.AddGroup("ConvertRuleItem", group =>
            {
                ...
                this.Description = group.Add(new VocabularyKey("Description", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    ...
                    .WithDescription(@"Type additional information to describe the rule item for automatic record creation.")
                    .WithDisplayName("Description")
                    .ModelProperty("description", typeof(string)));

                this.Name = group.Add(new VocabularyKey("Name", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable(), k => k.MaxLength(100))
                    .WithDescription(@"Type a name or title of the rule item that is used for automatic record creation and update.")
                    .WithDisplayName("Name")
                    .ModelProperty("name", typeof(string)));

                this.ConditionId = group.Add(new VocabularyKey("ConditionId", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Identifies the step of the associated workflow")
                    .WithDisplayName("Condition")
                    .ModelProperty("conditionid", typeof(string)));

                this.ConvertRuleItemId = group.Add(new VocabularyKey("ConvertRuleItemId", VocabularyKeyDataType.Guid, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Unique identifier for entity instances")
                    .WithDisplayName("Routing Rule")
                    .ModelProperty("convertruleitemid", typeof(Guid)));
                ...
                this.ConvertRuleId = group.Add(new VocabularyKey("ConvertRuleId", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"Unique identifier of the convert rule associated with the convert rule item.")
                    .WithDisplayName("Show the conversion rule associated to this rule item")
                    .ModelProperty("convertruleid", typeof(string)));

                this.ConvertRuleIdName = group.Add(new VocabularyKey("ConvertRuleIdName", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit(), k => k.MaxLength(100))
                    .WithDescription(@"")
                    .WithDisplayName("ConvertRuleIdName")
                    .ModelProperty("convertruleidname", typeof(string)));

                this.VersionNumber = group.Add(new VocabularyKey("VersionNumber", VocabularyKeyDataType.Integer, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Version number of the Covert Rule Item.")
                ...
                this.WorkflowId = group.Add(new VocabularyKey("WorkflowId", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"Workflow associated with the Convert Rule Item.")
                ...
                this.OwningBusinessUnit = group.Add(new VocabularyKey("OwningBusinessUnit", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Shows the business unit that the convert rule item owner belongs to.")
                    .WithDisplayName("Owning Business Unit")
                    .ModelProperty("owningbusinessunit", typeof(string)));

                this.OwningUser = group.Add(new VocabularyKey("OwningUser", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Unique identifier of the user who owns the Convert Rule Item.")
                ...
                this.ConditionXml = group.Add(new VocabularyKey("ConditionXml", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    ...
                    .WithDescription(@"Condition for convert rule item")
                ...
                this.SequenceNumber = group.Add(new VocabularyKey("SequenceNumber", VocabularyKeyDataType.Integer, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"Sequence number of the convert rule item")
                    .WithDisplayName("Sequence Number")
                    .ModelProperty("sequencenumber", typeof(long)));

                this.PropertiesXml = group.Add(new VocabularyKey("PropertiesXml", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable(), k => k.MaxLength(1073741823))
                    .WithDescription(@"Set properties xml for convert rule item")
                    .WithDisplayName("SetPropertiesXml")
                    .ModelProperty("propertiesxml", typeof(string)));
                ...
                this.ConvertRuleItemIdUnique = group.Add(new VocabularyKey("ConvertRuleItemIdUnique", VocabularyKeyDataType.Guid, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"For internal use only.")
                    .WithDisplayName("Unique Id")
                    .ModelProperty("convertruleitemidunique", typeof(Guid)));
        ...
        public VocabularyKey ConvertRuleItemId { get; private set; }
        ...
        public VocabularyKey ConvertRuleIdName { get; private set; }
        ...
        public VocabularyKey PropertiesXml { get; private set; }
        ...
        public VocabularyKey ConvertRuleItemIdUnique { get; private set; }
