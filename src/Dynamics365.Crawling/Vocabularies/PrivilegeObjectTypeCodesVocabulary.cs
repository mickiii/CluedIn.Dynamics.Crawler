...
{
    public class PrivilegeObjectTypeCodesVocabulary : SimpleVocabulary
    {
        public PrivilegeObjectTypeCodesVocabulary()
        {
            VocabularyName = "Dynamics365 PrivilegeObjectTypeCodes";
            KeyPrefix = "dynamics365.privilegeobjecttypecodes";
            KeySeparator = ".";
            Grouping = EntityType.Unknown; // TODO: Set value

            this.AddGroup("PrivilegeObjectTypeCodes", group =>
            {
                ...
                this.PrivilegeId = group.Add(new VocabularyKey("PrivilegeId", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"For internal use only.")
                    .WithDisplayName("PrivilegeId")
                    .ModelProperty("privilegeid", typeof(string)));

                this.PrivilegeObjectTypeCodeId = group.Add(new VocabularyKey("PrivilegeObjectTypeCodeId", VocabularyKeyDataType.Guid, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"For internal use only.")
                    .WithDisplayName("PrivilegeObjectTypeCodeId")
                    .ModelProperty("privilegeobjecttypecodeid", typeof(Guid)));
                ...
                this.PrivilegeObjectTypeCodeRowId = group.Add(new VocabularyKey("PrivilegeObjectTypeCodeRowId", VocabularyKeyDataType.Guid, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Unique identifier of the PrivlegeObjectTypeCode used when synchronizing customizations for the Microsoft Dynamics CRM client for Outlook")
                    .WithDisplayName("App Module Unique Id")
                    .ModelProperty("privilegeobjecttypecoderowid", typeof(Guid)));
        ...
        public VocabularyKey PrivilegeObjectTypeCodeId { get; private set; }
        ...
        public VocabularyKey PrivilegeObjectTypeCodeRowId { get; private set; }
