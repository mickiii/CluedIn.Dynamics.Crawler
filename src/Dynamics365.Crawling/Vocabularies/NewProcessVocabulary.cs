...
{
    public class NewProcessVocabulary : SimpleVocabulary
    {
        public NewProcessVocabulary()
        {
            VocabularyName = "Dynamics365 NewProcess";
            KeyPrefix = "dynamics365.newprocess";
            KeySeparator = ".";
            Grouping = EntityType.Unknown; // TODO: Set value

            this.AddGroup("NewProcess", group =>
            {
                this.BusinessProcessFlowInstanceId = group.Add(new VocabularyKey("BusinessProcessFlowInstanceId", VocabularyKeyDataType.Guid, VocabularyKeyVisibility.Visible)
                    ...
                    .WithDescription(@"Unique identifier for New Process bpf entity instances")
                    .WithDisplayName("New Process Instance Id")
                ...
                this.KnowledgeArticleId = group.Add(new VocabularyKey("KnowledgeArticleId", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"Unique identifier of the Knowledge Article associated to the Business Process Flow instance.")
                ...
                this.Duration = group.Add(new VocabularyKey("Duration", VocabularyKeyDataType.Integer, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Duration the business process flow was active.")
