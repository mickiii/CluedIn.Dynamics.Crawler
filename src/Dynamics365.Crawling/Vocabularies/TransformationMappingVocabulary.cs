using System;
    ...
    {
        public class TransformationMappingVocabulary : SimpleVocabulary
        {
            public TransformationMappingVocabulary()
            {
                VocabularyName = "Dynamics365 TransformationMapping";
                KeyPrefix = "dynamics365.transformationmapping";
                KeySeparator = ".";
                Grouping = EntityType.Unknown; // TODO: Set value

                this.AddGroup("TransformationMapping", group =>
                {
                    ...
                    this.TransformationTypeName = group.Add(new VocabularyKey("TransformationTypeName", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                        .WithDataAnnotations(k => k.NotEditable(), k => k.MaxLength(256))
                        .WithDescription(@"Type of transformation.")
                        .WithDisplayName("Transformation Type Name")
                        .ModelProperty("transformationtypename", typeof(string)));
                    
                    this.ProcessCode = group.Add(new VocabularyKey("ProcessCode", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                        .WithDataAnnotations(k => k.NotEditable())
                        .WithDescription(@"Information about whether the transformation mapping needs to be processed.")
                    ...
                    this.StatusCode = group.Add(new VocabularyKey("StatusCode", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                        .WithDataAnnotations(k => k.NotEditable())
                        .WithDescription(@"Reason for the status of the transformation mapping.")
                        .WithDisplayName("Status Reason")
                        .ModelProperty("statuscode", typeof(string)));
                    
                    this.ModifiedOn = group.Add(new VocabularyKey("ModifiedOn", VocabularyKeyDataType.DateTime, VocabularyKeyVisibility.Visible)
                        .WithDataAnnotations(k => k.CanEdit())
                        .WithDescription(@"Date and time when the transformation mapping was last modified.")
                        .WithDisplayName("Modified On")
                        .ModelProperty("modifiedon", typeof(DateTime)));
                    
                    this.CreatedBy = group.Add(new VocabularyKey("CreatedBy", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                        .WithDataAnnotations(k => k.CanEdit())
                        .WithDescription(@"Unique identifier of the user who created the transformation mapping.")
                        .WithDisplayName("Created By")
                        .ModelProperty("createdby", typeof(string)));
                    
                    this.TransformationMappingId = group.Add(new VocabularyKey("TransformationMappingId", VocabularyKeyDataType.Guid, VocabularyKeyVisibility.Visible)
                        .WithDataAnnotations(k => k.CanEdit())
                        .WithDescription(@"Unique identifier of the transformation mapping.")
                        .WithDisplayName("TransformationMappingId")
                        .ModelProperty("transformationmappingid", typeof(Guid)));
                    
                    this.ModifiedBy = group.Add(new VocabularyKey("ModifiedBy", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                        .WithDataAnnotations(k => k.CanEdit())
                        .WithDescription(@"Unique identifier of the user who last modified the mapping.")
                        .WithDisplayName("Modified By")
                        .ModelProperty("modifiedby", typeof(string)));
                    
                    this.CreatedOn = group.Add(new VocabularyKey("CreatedOn", VocabularyKeyDataType.DateTime, VocabularyKeyVisibility.Visible)
                        .WithDataAnnotations(k => k.CanEdit())
                        .WithDescription(@"Date and time when the transformation mapping was created.")
                        .WithDisplayName("Created On")
                        .ModelProperty("createdon", typeof(DateTime)));
                    
                    this.StateCode = group.Add(new VocabularyKey("StateCode", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                        .WithDataAnnotations(k => k.CanEdit())
                        .WithDescription(@"Status of the transformation mapping.")
                    ...
                    this.TargetEntityName = group.Add(new VocabularyKey("TargetEntityName", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                        ...
                        .WithDisplayName("Target Entity Name")
                    ...
                    this.StatusCodeName = group.Add(new VocabularyKey("StatusCodeName", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                        .WithDataAnnotations(k => k.CanEdit())
                        .WithDescription(@"Name of the status reason of the transformation mapping.")
                    ...
                    this.StateCodeName = group.Add(new VocabularyKey("StateCodeName", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                        .WithDataAnnotations(k => k.CanEdit())
                        .WithDescription(@"Status name of the transformation mapping.")
                    ...
                    this.CreatedOnBehalfBy = group.Add(new VocabularyKey("CreatedOnBehalfBy", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                        .WithDataAnnotations(k => k.CanEdit())
                        .WithDescription(@"Unique identifier of the delegate user who created the transformationmapping.")
                    ...
                    this.ModifiedOnBehalfBy = group.Add(new VocabularyKey("ModifiedOnBehalfBy", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                        .WithDataAnnotations(k => k.CanEdit())
                        .WithDescription(@"Unique identifier of the delegate user who last modified the transformationmapping.")
                    ...
                    this.TransformationMappingIdUnique = group.Add(new VocabularyKey("TransformationMappingIdUnique", VocabularyKeyDataType.Guid, VocabularyKeyVisibility.Visible)
                        .WithDataAnnotations(k => k.CanEdit())
                        .WithDescription(@"Unique identifier of the Transformation Mapping.")
                        .WithDisplayName("TransformationMappingIdUnique")
                        .ModelProperty("transformationmappingidunique", typeof(Guid)));
        ...
        public VocabularyKey TransformationTypeName { get; private set; }
        ...
        public VocabularyKey TransformationMappingIdUnique { get; private set; }
