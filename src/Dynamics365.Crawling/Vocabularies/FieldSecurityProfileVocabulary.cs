...
{
    public class FieldSecurityProfileVocabulary : SimpleVocabulary
    {
        public FieldSecurityProfileVocabulary()
        {
            VocabularyName = "Dynamics365 FieldSecurityProfile";
            KeyPrefix = "dynamics365.fieldsecurityprofile";
            KeySeparator = ".";
            Grouping = EntityType.Unknown; // TODO: Set value

            this.AddGroup("FieldSecurityProfile", group =>
            {
                ...
                this.FieldSecurityProfileId = group.Add(new VocabularyKey("FieldSecurityProfileId", VocabularyKeyDataType.Guid, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Unique identifier of the profile.")
                    .WithDisplayName("Field Security Profile")
                    .ModelProperty("fieldsecurityprofileid", typeof(Guid)));
                ...
                this.FieldSecurityProfileIdUnique = group.Add(new VocabularyKey("FieldSecurityProfileIdUnique", VocabularyKeyDataType.Guid, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"For internal use only.")
                    .WithDisplayName("Field Security Profile")
                    .ModelProperty("fieldsecurityprofileidunique", typeof(Guid)));
        ...
        public VocabularyKey FieldSecurityProfileIdUnique { get; private set; }
