...
{
    public class ContractTemplateVocabulary : SimpleVocabulary
    {
        public ContractTemplateVocabulary()
        {
            VocabularyName = "Dynamics365 ContractTemplate";
            KeyPrefix = "dynamics365.contracttemplate";
            KeySeparator = ".";
            Grouping = EntityType.Unknown; // TODO: Set value

            this.AddGroup("ContractTemplate", group =>
            {
                this.ContractTemplateId = group.Add(new VocabularyKey("ContractTemplateId", VocabularyKeyDataType.Guid, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Unique identifier of the contract template.")
                    .WithDisplayName("Contract Template")
                    .ModelProperty("contracttemplateid", typeof(Guid)));

                this.Name = group.Add(new VocabularyKey("Name", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable(), k => k.MaxLength(100))
                    .WithDescription(@"Name of the contract template.")
                    .WithDisplayName("Name")
                    .ModelProperty("name", typeof(string)));

                this.OrganizationId = group.Add(new VocabularyKey("OrganizationId", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"organization_contract_templates")
                    .WithDisplayName("Organization")
                    .ModelProperty("organizationid", typeof(string)));

                this.Description = group.Add(new VocabularyKey("Description", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable(), k => k.MaxLength(2000))
                    .WithDescription(@"Description of the contract template.")
                    .WithDisplayName("Description")
                    .ModelProperty("description", typeof(string)));

                this.Abbreviation = group.Add(new VocabularyKey("Abbreviation", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable(), k => k.MaxLength(20))
                    .WithDescription(@"Abbreviation of the contract template name.")
                    .WithDisplayName("Abbreviation")
                    .ModelProperty("abbreviation", typeof(string)));
                ...
                this.ContractServiceLevelCode = group.Add(new VocabularyKey("ContractServiceLevelCode", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    ...
                    .WithDescription(@"Unique identifier of the level of service specified in contracts that are based on the template.")
                    .WithDisplayName("Contract Service Level")
                ...
                this.BillingFrequencyCode = group.Add(new VocabularyKey("BillingFrequencyCode", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"How often the customer or account is to be billed in contracts that are based on the template.")
                ...
                this.AllotmentTypeCode = group.Add(new VocabularyKey("AllotmentTypeCode", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"Criteria for the contracts based on the template, such as number of cases, time, or coverage dates.")
                ...
                this.UseDiscountAsPercentage = group.Add(new VocabularyKey("UseDiscountAsPercentage", VocabularyKeyDataType.Boolean, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"Specifies whether the discount is a percentage or a monetary amount in contracts based on the template.")
                    .WithDisplayName("Use Discount as Percentage")
                ...
                this.EffectivityCalendar = group.Add(new VocabularyKey("EffectivityCalendar", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    ...
                    .WithDescription(@"Days of the week and times for which contracts based on the template are effective.")
                    .WithDisplayName("Support Calendar")
                    .ModelProperty("effectivitycalendar", typeof(string)));

                this.CreatedOn = group.Add(new VocabularyKey("CreatedOn", VocabularyKeyDataType.DateTime, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Date and time when the contract template was created.")
                    .WithDisplayName("Created On")
                    .ModelProperty("createdon", typeof(DateTime)));

                this.CreatedBy = group.Add(new VocabularyKey("CreatedBy", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"lk_contracttemplatebase_createdby")
                    .WithDisplayName("Created By")
                    .ModelProperty("createdby", typeof(string)));

                this.ModifiedBy = group.Add(new VocabularyKey("ModifiedBy", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"lk_contracttemplatebase_modifiedby")
                    .WithDisplayName("Modified By")
                    .ModelProperty("modifiedby", typeof(string)));

                this.ModifiedOn = group.Add(new VocabularyKey("ModifiedOn", VocabularyKeyDataType.DateTime, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Date and time when the contract template was last modified.")
                ...
                this.ContractTemplateIdUnique = group.Add(new VocabularyKey("ContractTemplateIdUnique", VocabularyKeyDataType.Guid, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"For internal use only.")
                    .WithDisplayName("ContractTemplateIdUnique")
                    .ModelProperty("contracttemplateidunique", typeof(Guid)));
                ...
                this.CreatedOnBehalfBy = group.Add(new VocabularyKey("CreatedOnBehalfBy", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"lk_contracttemplate_createdonbehalfby")
                ...
                this.ModifiedOnBehalfBy = group.Add(new VocabularyKey("ModifiedOnBehalfBy", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"lk_contracttemplate_modifiedonbehalfby")
        ...
        public VocabularyKey ContractTemplateIdUnique { get; private set; }
