...
{
    public class ExpiredProcessVocabulary : SimpleVocabulary
    {
        public ExpiredProcessVocabulary()
        {
            VocabularyName = "Dynamics365 ExpiredProcess";
            KeyPrefix = "dynamics365.expiredprocess";
            KeySeparator = ".";
            Grouping = EntityType.Unknown; // TODO: Set value

            this.AddGroup("ExpiredProcess", group =>
            {
                this.BusinessProcessFlowInstanceId = group.Add(new VocabularyKey("BusinessProcessFlowInstanceId", VocabularyKeyDataType.Guid, VocabularyKeyVisibility.Visible)
                    ...
                    .WithDescription(@"Unique identifier for Expired Process bpf entity instances")
                    .WithDisplayName("Expired Process Instance Id")
