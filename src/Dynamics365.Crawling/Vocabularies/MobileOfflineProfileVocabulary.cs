...
{
    public class MobileOfflineProfileVocabulary : SimpleVocabulary
    {
        public MobileOfflineProfileVocabulary()
        {
            VocabularyName = "Dynamics365 MobileOfflineProfile";
            KeyPrefix = "dynamics365.mobileofflineprofile";
            KeySeparator = ".";
            Grouping = EntityType.Unknown; // TODO: Set value

            this.AddGroup("MobileOfflineProfile", group =>
            {
                this.MobileOfflineProfileId = group.Add(new VocabularyKey("MobileOfflineProfileId", VocabularyKeyDataType.Guid, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Unique identifier of the mobile offline profile.")
                    .WithDisplayName("Mobile Offline Profile")
                    .ModelProperty("mobileofflineprofileid", typeof(Guid)));

                this.Name = group.Add(new VocabularyKey("Name", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable(), k => k.MaxLength(255))
                    .WithDescription(@"Enter the name of the mobile offline profile.")
                    .WithDisplayName("Name")
                    .ModelProperty("name", typeof(string)));

                this.Description = group.Add(new VocabularyKey("Description", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable(), k => k.MaxLength(2000))
                    .WithDescription(@"Enter a description of the mobile offline profile.")
                    .WithDisplayName("Description")
                    .ModelProperty("description", typeof(string)));

                this.VersionNumber = group.Add(new VocabularyKey("VersionNumber", VocabularyKeyDataType.Integer, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Version number of the Mobile Offline Profile.")
                ...
                this.OrganizationId = group.Add(new VocabularyKey("OrganizationId", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Unique identifier of the organization associated with the Mobile Offline Profile.")
                ...
                this.MobileOfflineProfileIdUnique = group.Add(new VocabularyKey("MobileOfflineProfileIdUnique", VocabularyKeyDataType.Guid, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"For Internal Use Only")
                    .WithDisplayName("Unique Id")
                    .ModelProperty("mobileofflineprofileidunique", typeof(Guid)));
                ...
                this.IntroducedVersion = group.Add(new VocabularyKey("IntroducedVersion", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    ...
                    .WithDescription(@"Version in which the Mobile offline Profile is introduced.")
                ...
                this.IsValidated = group.Add(new VocabularyKey("IsValidated", VocabularyKeyDataType.Boolean, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Information about whether profile is validated or not")
                    .WithDisplayName("Is Validated")
        ...
        public VocabularyKey MobileOfflineProfileIdUnique { get; private set; }
