...
{
    public class PostCommentVocabulary : SimpleVocabulary
    {
        public PostCommentVocabulary()
        {
            VocabularyName = "Dynamics365 PostComment";
            KeyPrefix = "dynamics365.postcomment";
            KeySeparator = ".";
            Grouping = EntityType.Unknown; // TODO: Set value

            this.AddGroup("PostComment", group =>
            {
                ...
                this.PostCommentId = group.Add(new VocabularyKey("PostCommentId", VocabularyKeyDataType.Guid, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Shows the ID of the post comment.")
                    .WithDisplayName("PostComment")
                    .ModelProperty("postcommentid", typeof(Guid)));

                this.PostId = group.Add(new VocabularyKey("PostId", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Unique identifier of the post with which the comment is associated.")
                ...
                this.Text = group.Add(new VocabularyKey("Text", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    ...
                    .WithDescription(@"Text of the comment.")
        ...
        public VocabularyKey PostCommentId { get; private set; }
