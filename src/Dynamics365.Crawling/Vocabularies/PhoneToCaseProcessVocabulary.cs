...
{
    public class PhoneToCaseProcessVocabulary : SimpleVocabulary
    {
        public PhoneToCaseProcessVocabulary()
        {
            VocabularyName = "Dynamics365 PhoneToCaseProcess";
            KeyPrefix = "dynamics365.phonetocaseprocess";
            KeySeparator = ".";
            Grouping = EntityType.Unknown; // TODO: Set value

            this.AddGroup("PhoneToCaseProcess", group =>
            {
                this.BusinessProcessFlowInstanceId = group.Add(new VocabularyKey("BusinessProcessFlowInstanceId", VocabularyKeyDataType.Guid, VocabularyKeyVisibility.Visible)
                    ...
                    .WithDescription(@"Unique identifier for Phone To Case Process bpf entity instances")
                    .WithDisplayName("Phone To Case Process Instance Id")
                ...
                this.ActiveStageId = group.Add(new VocabularyKey("ActiveStageId", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    ...
                    .WithDescription(@"lk_phonetocaseprocess_activestageid")
                ...
                this.ProcessId = group.Add(new VocabularyKey("ProcessId", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"lk_phonetocaseprocess_processid")
                ...
                this.IncidentId = group.Add(new VocabularyKey("IncidentId", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"lk_phonetocaseprocess_incidentid")
                    .WithDisplayName("Incident")
                ...
                this.TransactionCurrencyId = group.Add(new VocabularyKey("TransactionCurrencyId", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"transactioncurrency_phonetocaseprocess")
