...
namespace CluedIn.Crawling.Dynamics365.Vocabularies
{
    public class LeadToOpportunitySalesProcessVocabulary : SimpleVocabulary
    {
        ...
        {
            VocabularyName = "Dynamics365 LeadToOpportunitySalesProcess";
            KeyPrefix = "dynamics365.leadtoopportunitysalesprocess";
            KeySeparator = ".";
            Grouping = EntityType.Unknown; // TODO: Set value

            this.AddGroup("LeadToOpportunitySalesProcess", group =>
            {
                this.BusinessProcessFlowInstanceId = group.Add(new VocabularyKey("BusinessProcessFlowInstanceId", VocabularyKeyDataType.Guid, VocabularyKeyVisibility.Visible)
                    ...
                    .WithDescription(@"Unique identifier for Lead To Opportunity Sales Process bpf entity instances")
                    .WithDisplayName("Lead To Opportunity Sales Process Instance Id")
                ...
                this.ActiveStageId = group.Add(new VocabularyKey("ActiveStageId", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    ...
                    .WithDescription(@"lk_leadtoopportunitysalesprocess_activestageid")
                ...
                this.CompletedOn = group.Add(new VocabularyKey("CompletedOn", VocabularyKeyDataType.DateTime, VocabularyKeyVisibility.Visible)
                    ...
                    .WithDisplayName("Active Stage Completed On")
                ...
                this.ProcessId = group.Add(new VocabularyKey("ProcessId", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"lk_leadtoopportunitysalesprocess_processid")
                ...
                this.LeadId = group.Add(new VocabularyKey("LeadId", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"lk_leadtoopportunitysalesprocess_leadid")
                    .WithDisplayName("Lead")
                    .ModelProperty("leadid", typeof(string)));

                this.LeadIdName = group.Add(new VocabularyKey("LeadIdName", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit(), k => k.MaxLength(100))
                    .WithDescription(@"")
                    .WithDisplayName("LeadIdName")
                    .ModelProperty("leadidname", typeof(string)));

                this.OpportunityId = group.Add(new VocabularyKey("OpportunityId", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"lk_leadtoopportunitysalesprocess_opportunityid")
                    .WithDisplayName("Opportunity Id")
                ...
                this.TransactionCurrencyId = group.Add(new VocabularyKey("TransactionCurrencyId", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"transactioncurrency_leadtoopportunitysalesprocess")
        ...
        public VocabularyKey LeadIdName { get; private set; }
