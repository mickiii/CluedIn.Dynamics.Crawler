...
{
    public class RibbonRuleVocabulary : SimpleVocabulary
    {
        public RibbonRuleVocabulary()
        {
            VocabularyName = "Dynamics365 RibbonRule";
            KeyPrefix = "dynamics365.ribbonrule";
            KeySeparator = ".";
            Grouping = EntityType.Unknown; // TODO: Set value

            this.AddGroup("RibbonRule", group =>
            {
                this.RuleId = group.Add(new VocabularyKey("RuleId", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    ...
                    .WithDescription(@"The Id of a rule")
                    .WithDisplayName("RuleId")
                    .ModelProperty("ruleid", typeof(string)));

                this.RuleDefinition = group.Add(new VocabularyKey("RuleDefinition", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit(), k => k.MaxLength(100000))
                    .WithDescription(@"The definition of the rule - what entities, permissions, data values, etc. can change when this rule is true or false.")
                    .WithDisplayName("RuleDefinition")
                    .ModelProperty("ruledefinition", typeof(string)));
                ...
                this.RuleType = group.Add(new VocabularyKey("RuleType", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"The type of a rule")
                    .WithDisplayName("RuleType")
                    .ModelProperty("ruletype", typeof(string)));

                this.RibbonRuleUniqueId = group.Add(new VocabularyKey("RibbonRuleUniqueId", VocabularyKeyDataType.Guid, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    ...
                    .WithDisplayName("RibbonRuleUniqueId")
                    .ModelProperty("ribbonruleuniqueid", typeof(Guid)));
                ...
                this.RibbonRuleId = group.Add(new VocabularyKey("RibbonRuleId", VocabularyKeyDataType.Guid, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Unique identifier.")
                    .WithDisplayName("Primary Key")
                    .ModelProperty("ribbonruleid", typeof(Guid)));
        ...
        public VocabularyKey RuleDefinition { get; private set; }

        public VocabularyKey Entity { get; private set; }

        public VocabularyKey RuleType { get; private set; }

        public VocabularyKey RibbonRuleUniqueId { get; private set; }

        public VocabularyKey VersionNumber { get; private set; }

        public VocabularyKey OrganizationId { get; private set; }

        public VocabularyKey RibbonRuleId { get; private set; }
