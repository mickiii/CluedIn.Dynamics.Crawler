...
{
    public class ServicePlanVocabulary : SimpleVocabulary
    {
        public ServicePlanVocabulary()
        {
            VocabularyName = "Dynamics365 ServicePlan";
            KeyPrefix = "dynamics365.serviceplan";
            KeySeparator = ".";
            Grouping = EntityType.Unknown; // TODO: Set value

            this.AddGroup("ServicePlan", group =>
            {
                this.ServicePlanId = group.Add(new VocabularyKey("ServicePlanId", VocabularyKeyDataType.Guid, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"Unique identifier for entity instances")
                    .WithDisplayName("Service Plan")
                    .ModelProperty("serviceplanid", typeof(Guid)));
                ...
                this.Name = group.Add(new VocabularyKey("Name", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    ...
                    .WithDescription(@"The unique name of the service plan as defined in Azure Active Directory.")
                ...
                this.IsCustomizable = group.Add(new VocabularyKey("IsCustomizable", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"For internal use only.")
                    .WithDisplayName("Is Customizable")
                ...
                this.DisplayName = group.Add(new VocabularyKey("DisplayName", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable(), k => k.MaxLength(300))
                    .WithDescription(@"Display name of service plan")
        ...
        public VocabularyKey ServicePlanId { get; private set; }
