...
{
    public class AppConfigVocabulary : SimpleVocabulary
    {
        public AppConfigVocabulary()
        {
            VocabularyName = "Dynamics365 AppConfig";
            KeyPrefix = "dynamics365.appconfig";
            KeySeparator = ".";
            Grouping = EntityType.Unknown; // TODO: Set value

            this.AddGroup("AppConfig", group =>
            {
                this.AppModuleId = group.Add(new VocabularyKey("AppModuleId", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"Choose the app module to associate with the app configuration.")
                    .WithDisplayName("App Module ID")
                    .ModelProperty("appmoduleid", typeof(string)));

                this.AppConfigId = group.Add(new VocabularyKey("AppConfigId", VocabularyKeyDataType.Guid, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"System-populated app configuration ID.")
                    .WithDisplayName("App Config ID")
                    .ModelProperty("appconfigid", typeof(Guid)));
                ...
                this.SupportingSolutionId = group.Add(new VocabularyKey("SupportingSolutionId", VocabularyKeyDataType.Guid, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"For internal use only.")
                    .WithDisplayName("Supporting Solution ID")
                ...
                this.IsManaged = group.Add(new VocabularyKey("IsManaged", VocabularyKeyDataType.Boolean, VocabularyKeyVisibility.Visible)
                    ...
                    .WithDisplayName("Indicates whether this is part of a managed solution.")
                ...
                this.AppConfigIdUnique = group.Add(new VocabularyKey("AppConfigIdUnique", VocabularyKeyDataType.Guid, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.CanEdit())
                    .WithDescription(@"System-populated app configuration unique ID.")
                    .WithDisplayName("App Config ID Unique")
                    .ModelProperty("appconfigidunique", typeof(Guid)));

                this.StateCode = group.Add(new VocabularyKey("StateCode", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"Shows whether the app configuration is Active or Inactive. Inactive records are read-only and can't be edited unless they are reactivated.")
                ...
                this.StatusCode = group.Add(new VocabularyKey("StatusCode", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"Select the status.")
                ...
                this.AppConfigImportXml = group.Add(new VocabularyKey("AppConfigImportXml", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable(), k => k.MaxLength(1073741823))
                    .WithDescription(@"The App Config diff computed for managed solutions containing the AppConfig entity. For internal use only.")
                    .WithDisplayName("AppConfigImportXml")
                    .ModelProperty("appconfigimportxml", typeof(string)));
        ...
        public VocabularyKey AppConfigImportXml { get; private set; }
