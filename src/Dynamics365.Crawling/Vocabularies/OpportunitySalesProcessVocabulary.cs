...
{
    public class OpportunitySalesProcessVocabulary : SimpleVocabulary
    {
        public OpportunitySalesProcessVocabulary()
        {
            VocabularyName = "Dynamics365 OpportunitySalesProcess";
            KeyPrefix = "dynamics365.opportunitysalesprocess";
            KeySeparator = ".";
            Grouping = EntityType.Unknown; // TODO: Set value

            this.AddGroup("OpportunitySalesProcess", group =>
            {
                this.BusinessProcessFlowInstanceId = group.Add(new VocabularyKey("BusinessProcessFlowInstanceId", VocabularyKeyDataType.Guid, VocabularyKeyVisibility.Visible)
                    ...
                    .WithDescription(@"Unique identifier for Opportunity Sales Process bpf entity instances")
                    .WithDisplayName("Opportunity Sales Process Instance Id")
                ...
                this.ActiveStageId = group.Add(new VocabularyKey("ActiveStageId", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    ...
                    .WithDescription(@"lk_opportunitysalesprocess_activestageid")
                ...
                this.ProcessId = group.Add(new VocabularyKey("ProcessId", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"lk_opportunitysalesprocess_processid")
                ...
                this.OpportunityId = group.Add(new VocabularyKey("OpportunityId", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"lk_opportunitysalesprocess_opportunityid")
                ...
                this.QuoteId = group.Add(new VocabularyKey("QuoteId", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"lk_opportunitysalesprocess_quoteid")
                    .WithDisplayName("Related Quote")
                ...
                this.SalesOrderId = group.Add(new VocabularyKey("SalesOrderId", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"lk_opportunitysalesprocess_salesorderid")
                    .WithDisplayName("Related Sales Order")
                ...
                this.TransactionCurrencyId = group.Add(new VocabularyKey("TransactionCurrencyId", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)
                    .WithDataAnnotations(k => k.NotEditable())
                    .WithDescription(@"transactioncurrency_opportunitysalesprocess")
