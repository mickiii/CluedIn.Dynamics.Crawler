...
{
    public abstract class MailboxTrackingFolderClueProducer<T> : DynamicsClueProducer<T> where T : MailboxTrackingFolder
    {
        private readonly IClueFactory _factory;

        private readonly Dynamics365CrawlJobData _dynamics365CrawlJobData;

        public MailboxTrackingFolderClueProducer([NotNull] IClueFactory factory, IAgentJobProcessorState<CrawlJobData> state)
        {
            if (factory == null)
        ...
        protected override Clue MakeClueImpl([NotNull] T input, Guid accountId)
        {
            ...
            var clue = this._factory.Create(EntityType.Unknown, input.MailboxTrackingFolderId.ToString(), accountId);

            var data = clue.Data.EntityData;

            if (Uri.TryCreate(string.Format("{0}/main.aspx?pagetype=entityrecord&etn=mailboxtrackingfolder&id={1}", _dynamics365CrawlJobData.Api, input.MailboxTrackingFolderId.ToString()), UriKind.Absolute, out Uri uri))
                data.Uri = uri;
            ...
            */
            data.Properties[Dynamics365Vocabulary.MailboxTrackingFolder.MailboxTrackingFolderId] = input.MailboxTrackingFolderId.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.MailboxTrackingFolder.OrganizationId] = input.OrganizationId.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.MailboxTrackingFolder.MailboxId] = input.MailboxId.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.MailboxTrackingFolder.ExchangeFolderId] = input.ExchangeFolderId.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.MailboxTrackingFolder.RegardingObjectId] = input.RegardingObjectId.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.MailboxTrackingFolder.RegardingObjectTypeCode] = input.RegardingObjectTypeCode.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.MailboxTrackingFolder.RegardingObjectIdName] = input.RegardingObjectIdName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.MailboxTrackingFolder.FolderOnboardingStatus] = input.FolderOnboardingStatus.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.MailboxTrackingFolder.CreatedOn] = input.CreatedOn.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.MailboxTrackingFolder.ModifiedOn] = input.ModifiedOn.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.MailboxTrackingFolder.ExchangeFolderName] = input.ExchangeFolderName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.MailboxTrackingFolder.CreatedBy] = input.CreatedBy.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.MailboxTrackingFolder.CreatedByName] = input.CreatedByName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.MailboxTrackingFolder.CreatedByYomiName] = input.CreatedByYomiName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.MailboxTrackingFolder.CreatedOnBehalfBy] = input.CreatedOnBehalfBy.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.MailboxTrackingFolder.CreatedOnBehalfByName] = input.CreatedOnBehalfByName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.MailboxTrackingFolder.CreatedOnBehalfByYomiName] = input.CreatedOnBehalfByYomiName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.MailboxTrackingFolder.ModifiedBy] = input.ModifiedBy.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.MailboxTrackingFolder.ModifiedByName] = input.ModifiedByName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.MailboxTrackingFolder.ModifiedByYomiName] = input.ModifiedByYomiName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.MailboxTrackingFolder.ModifiedOnBehalfBy] = input.ModifiedOnBehalfBy.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.MailboxTrackingFolder.ModifiedOnBehalfByName] = input.ModifiedOnBehalfByName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.MailboxTrackingFolder.ModifiedOnBehalfByYomiName] = input.ModifiedOnBehalfByYomiName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.MailboxTrackingFolder.OwnerId] = input.OwnerId.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.MailboxTrackingFolder.VersionNumber] = input.VersionNumber.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.MailboxTrackingFolder.OwnerIdType] = input.OwnerIdType.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.MailboxTrackingFolder.OwningBusinessUnit] = input.OwningBusinessUnit.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.MailboxTrackingFolder.OwningTeam] = input.OwningTeam.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.MailboxTrackingFolder.OwningUser] = input.OwningUser.PrintIfAvailable();
