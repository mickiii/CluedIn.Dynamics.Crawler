...
{
    public abstract class SyncErrorClueProducer<T> : DynamicsClueProducer<T> where T : SyncError
    {
        private readonly IClueFactory _factory;

        private readonly Dynamics365CrawlJobData _dynamics365CrawlJobData;

        public SyncErrorClueProducer([NotNull] IClueFactory factory, IAgentJobProcessorState<CrawlJobData> state)
        {
            if (factory == null)
        ...
        protected override Clue MakeClueImpl([NotNull] T input, Guid accountId)
        {
            ...
            var clue = this._factory.Create(EntityType.Unknown, input.SyncErrorId.ToString(), accountId);

            var data = clue.Data.EntityData;

            if (Uri.TryCreate(string.Format("{0}/main.aspx?pagetype=entityrecord&etn=syncerror&id={1}", _dynamics365CrawlJobData.Api, input.SyncErrorId.ToString()), UriKind.Absolute, out Uri uri))
                data.Uri = uri;
            ...
            /*
             if (input.RegardingObjectId != null)
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.fieldpermission, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.activityparty, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.savedqueryvisualization, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.fileattachment, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.knowledgearticleviews, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.userqueryvisualization, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.slaitem, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.solution, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.internaladdress, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.channelaccessprofileruleitem, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.attachment, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.syncerror, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.duplicaterulecondition, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.processstage, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.teamtemplate, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.publisher, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.reportcategory, EntityEdgeType.Parent, input, input.RegardingObjectId);

                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.businessdatalocalizedlabel, EntityEdgeType.Parent, input, input.RegardingObjectId);

                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.socialprofile, EntityEdgeType.Parent, input, input.RegardingObjectId);

                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.slakpiinstance, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.processtrigger, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.offlinecommanddefinition, EntityEdgeType.Parent, input, input.RegardingObjectId);

                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.fieldsecurityprofile, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.workflow, EntityEdgeType.Parent, input, input.RegardingObjectId);
            ...
            */
            data.Properties[Dynamics365Vocabulary.SyncError.CreatedBy] = input.CreatedBy.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.CreatedByName] = input.CreatedByName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.CreatedByYomiName] = input.CreatedByYomiName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.CreatedOn] = input.CreatedOn.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.CreatedOnBehalfBy] = input.CreatedOnBehalfBy.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.CreatedOnBehalfByName] = input.CreatedOnBehalfByName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.CreatedOnBehalfByYomiName] = input.CreatedOnBehalfByYomiName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.ModifiedBy] = input.ModifiedBy.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.ModifiedByName] = input.ModifiedByName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.ModifiedByYomiName] = input.ModifiedByYomiName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.ModifiedOn] = input.ModifiedOn.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.ModifiedOnBehalfBy] = input.ModifiedOnBehalfBy.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.ModifiedOnBehalfByName] = input.ModifiedOnBehalfByName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.ModifiedOnBehalfByYomiName] = input.ModifiedOnBehalfByYomiName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.OwnerId] = input.OwnerId.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.OwnerIdName] = input.OwnerIdName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.OwnerIdType] = input.OwnerIdType.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.OwnerIdYomiName] = input.OwnerIdYomiName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.OwningBusinessUnit] = input.OwningBusinessUnit.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.OwningTeam] = input.OwningTeam.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.OwningUser] = input.OwningUser.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.SyncErrorId] = input.SyncErrorId.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.Name] = input.Name.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.Action] = input.Action.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.ErrorMessage] = input.ErrorMessage.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.ErrorDetail] = input.ErrorDetail.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.ActionData] = input.ActionData.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.RegardingObjectId] = input.RegardingObjectId.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.RegardingObjectIdName] = input.RegardingObjectIdName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.RegardingObjectIdYomiName] = input.RegardingObjectIdYomiName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.RegardingObjectTypeCode] = input.RegardingObjectTypeCode.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.ErrorTime] = input.ErrorTime.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.VersionNumber] = input.VersionNumber.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.RequestData] = input.RequestData.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.ErrorType] = input.ErrorType.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.ErrorTypeName] = input.ErrorTypeName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.StatusCode] = input.StatusCode.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.StatusCodeName] = input.StatusCodeName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.StateCode] = input.StateCode.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.StateCodeName] = input.StateCodeName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.Description] = input.Description.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.SyncError.ErrorCode] = input.ErrorCode.PrintIfAvailable();
