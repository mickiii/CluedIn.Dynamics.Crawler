...
{
    public abstract class AsyncOperationClueProducer<T> : DynamicsClueProducer<T> where T : AsyncOperation
    {
        private readonly IClueFactory _factory;

        private readonly Dynamics365CrawlJobData _dynamics365CrawlJobData;

        public AsyncOperationClueProducer([NotNull] IClueFactory factory, IAgentJobProcessorState<CrawlJobData> state)
        {
            if (factory == null)
        ...
        protected override Clue MakeClueImpl([NotNull] T input, Guid accountId)
        {
            ...
            var clue = this._factory.Create(EntityType.Unknown, input.AsyncOperationId.ToString(), accountId);

            var data = clue.Data.EntityData;

            if (Uri.TryCreate(string.Format("{0}/main.aspx?pagetype=entityrecord&etn=asyncoperation&id={1}", _dynamics365CrawlJobData.Api, input.AsyncOperationId.ToString()), UriKind.Absolute, out Uri uri))
                data.Uri = uri;
            ...
            /*
             if (input.RegardingObjectId != null)
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.quoteclose, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.activitypointer, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.commitment, EntityEdgeType.Parent, input, input.RegardingObjectId);

                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.flowsession, EntityEdgeType.Parent, input, input.RegardingObjectId);

                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.incidentknowledgebaserecord, EntityEdgeType.Parent, input, input.RegardingObjectId);

                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.topicmodelexecutionhistory, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.quarterlyfiscalcalendar, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.dynamicpropertyassociation, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.bulkoperationlog, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.monthlyfiscalcalendar, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.incidentresolution, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.activitymimeattachment, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.competitoraddress, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.relationshiprolemap, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.contactleads, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.topicmodelconfiguration, EntityEdgeType.Parent, input, input.RegardingObjectId);

                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.campaignitem, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.bookableresourcebookingexchangesyncidmapping, EntityEdgeType.Parent, input, input.RegardingObjectId);

                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.userquery, EntityEdgeType.Parent, input, input.RegardingObjectId);

                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.calendar, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.annualfiscalcalendar, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.salesprocessinstance, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.listmember, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.dynamicproperty, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.isvconfig, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.opportunityclose, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.systemform, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.role, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.importdata, EntityEdgeType.Parent, input, input.RegardingObjectId);

                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.entitlementcontacts, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.competitorproduct, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.competitorsalesliterature, EntityEdgeType.Parent, input, input.RegardingObjectId);

                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.topicmodel, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.contactquotes, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.topic, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.savedquery, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.importfile, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.childincidentcount, EntityEdgeType.Parent, input, input.RegardingObjectId);

                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.fixedmonthlyfiscalcalendar, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.importlog, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.servicecontractcontacts, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.postfollow, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.leadaddress, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.leadcompetitors, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.resourcegroupexpansion, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.dynamicpropertyoptionsetitem, EntityEdgeType.Parent, input, input.RegardingObjectId);

                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.similarityrule, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.entitlementproducts, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.importmap, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.displaystring, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.orderclose, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.uom, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.resource, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.productsalesliterature, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.attributeimageconfig, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.opportunitycompetitors, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.accountleads, EntityEdgeType.Parent, input, input.RegardingObjectId);

                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.socialprofile, EntityEdgeType.Parent, input, input.RegardingObjectId);

                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.entitlementtemplateproducts, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.resourcespec, EntityEdgeType.Parent, input, input.RegardingObjectId);

                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.resourcegroup, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.leadproduct, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.entitlementtemplatechannel, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.privilege, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.campaignactivityitem, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.WorkflowActivationId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.workflow, EntityEdgeType.Parent, input, input.WorkflowActivationId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.organization, EntityEdgeType.Parent, input, input.RegardingObjectId);

                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.post, EntityEdgeType.Parent, input, input.RegardingObjectId);

                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.entitymap, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.topichistory, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.attributemap, EntityEdgeType.Parent, input, input.RegardingObjectId);

                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.msdyn_slakpi, EntityEdgeType.Parent, input, input.RegardingObjectId);

                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.dynamicpropertyinstance, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.entityanalyticsconfig, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.uomschedule, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.import, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.OwningExtensionId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.sdkmessageprocessingstep, EntityEdgeType.Parent, input, input.OwningExtensionId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.contactorders, EntityEdgeType.Parent, input, input.RegardingObjectId);

                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.gnh_posdata, EntityEdgeType.Parent, input, input.RegardingObjectId);

                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.semiannualfiscalcalendar, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.userform, EntityEdgeType.Parent, input, input.RegardingObjectId);

                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.cdi_emailsend, EntityEdgeType.Parent, input, input.RegardingObjectId);

                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.contactinvoices, EntityEdgeType.Parent, input, input.RegardingObjectId);
                         ...
                         if (input.RegardingObjectId != null)
                            _factory.CreateOutgoingEntityReference(clue, EntityType.entityimageconfig, EntityEdgeType.Parent, input, input.RegardingObjectId);
            ...
            */
            data.Properties[Dynamics365Vocabulary.AsyncOperation.MessageName] = input.MessageName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.Depth] = input.Depth.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.PrimaryEntityType] = input.PrimaryEntityType.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.Data] = input.Data.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.RegardingObjectId] = input.RegardingObjectId.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.WorkflowStageName] = input.WorkflowStageName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.OperationType] = input.OperationType.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.DependencyToken] = input.DependencyToken.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.RecurrencePattern] = input.RecurrencePattern.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.Name] = input.Name.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.PostponeUntil] = input.PostponeUntil.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.WorkflowState] = input.WorkflowState.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.TimeZoneRuleVersionNumber] = input.TimeZoneRuleVersionNumber.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.OwningBusinessUnit] = input.OwningBusinessUnit.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.IsWaitingForEvent] = input.IsWaitingForEvent.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.CreatedBy] = input.CreatedBy.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.ErrorCode] = input.ErrorCode.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.ModifiedBy] = input.ModifiedBy.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.CorrelationId] = input.CorrelationId.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.RecurrenceStartTime] = input.RecurrenceStartTime.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.StatusCode] = input.StatusCode.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.AsyncOperationId] = input.AsyncOperationId.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.Sequence] = input.Sequence.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.RequestId] = input.RequestId.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.WorkflowIsBlocked] = input.WorkflowIsBlocked.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.ModifiedOn] = input.ModifiedOn.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.Message] = input.Message.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.StartedOn] = input.StartedOn.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.HostId] = input.HostId.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.StateCode] = input.StateCode.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.WorkflowActivationId] = input.WorkflowActivationId.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.CompletedOn] = input.CompletedOn.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.CorrelationUpdatedTime] = input.CorrelationUpdatedTime.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.UTCConversionTimeZoneCode] = input.UTCConversionTimeZoneCode.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.OwnerId] = input.OwnerId.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.RetryCount] = input.RetryCount.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.CreatedOn] = input.CreatedOn.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.OwningUser] = input.OwningUser.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.OwnerIdType] = input.OwnerIdType.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.RegardingObjectIdName] = input.RegardingObjectIdName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.PrimaryEntityTypeName] = input.PrimaryEntityTypeName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.ModifiedByName] = input.ModifiedByName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.StatusCodeName] = input.StatusCodeName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.WorkflowActivationIdName] = input.WorkflowActivationIdName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.OperationTypeName] = input.OperationTypeName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.OwnerIdName] = input.OwnerIdName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.RegardingObjectTypeCode] = input.RegardingObjectTypeCode.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.RegardingObjectIdYomiName] = input.RegardingObjectIdYomiName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.CreatedByName] = input.CreatedByName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.StateCodeName] = input.StateCodeName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.OwnerIdYomiName] = input.OwnerIdYomiName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.CreatedByYomiName] = input.CreatedByYomiName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.ModifiedByYomiName] = input.ModifiedByYomiName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.FriendlyMessage] = input.FriendlyMessage.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.CreatedOnBehalfBy] = input.CreatedOnBehalfBy.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.CreatedOnBehalfByName] = input.CreatedOnBehalfByName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.CreatedOnBehalfByYomiName] = input.CreatedOnBehalfByYomiName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.ModifiedOnBehalfBy] = input.ModifiedOnBehalfBy.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.ModifiedOnBehalfByName] = input.ModifiedOnBehalfByName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.ModifiedOnBehalfByYomiName] = input.ModifiedOnBehalfByYomiName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.OwningExtensionId] = input.OwningExtensionId.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.OwningExtensionIdName] = input.OwningExtensionIdName.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.OwningExtensionTypeCode] = input.OwningExtensionTypeCode.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.OwningTeam] = input.OwningTeam.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.ExecutionTimeSpan] = input.ExecutionTimeSpan.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.Subtype] = input.Subtype.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.ParentPluginExecutionId] = input.ParentPluginExecutionId.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.RootExecutionContext] = input.RootExecutionContext.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.Workload] = input.Workload.PrintIfAvailable();
            data.Properties[Dynamics365Vocabulary.AsyncOperation.ExpanderStartTime] = input.ExpanderStartTime.PrintIfAvailable();
