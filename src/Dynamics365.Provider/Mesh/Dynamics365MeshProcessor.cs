...
{
    public class Dynamics365_Command_MeshProcessor : BaseMeshProcessor
    {
        public Dynamics365_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          Dynamics365Constants.ProviderId;
