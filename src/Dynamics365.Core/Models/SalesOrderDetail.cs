...
{
    public class SalesOrderDetail : DynamicsModel
    {
        ...
        [JsonProperty("salesorderstatecode")]
        public string SalesOrderStateCode { get; set; }
        ...
        [JsonProperty("salesorderstatecodename")]
        public string SalesOrderStateCodeName { get; set; }
        ...
        [JsonProperty("salesorderispricelocked")]
        public bool? SalesOrderIsPriceLocked { get; set; }

        [JsonProperty("shipto_addressid")]
        public Guid? ShipTo_AddressId { get; set; }

        [JsonProperty("salesorderispricelockedname")]
        public string SalesOrderIsPriceLockedName { get; set; }
        ...
        [JsonProperty("salesorderidname")]
        public string SalesOrderIdName { get; set; }
