...
{
    public class DynamicPropertyAssociation : DynamicsModel
    {
        [JsonProperty("dynamicpropertyassociationid")]
        ...
        public string InheritanceState { get; set; }
        ...
        [JsonProperty("associationstatusname")]
        public string AssociationStatusName { get; set; }

        [JsonProperty("inheritancestatename")]
        public string InheritanceStateName { get; set; }
