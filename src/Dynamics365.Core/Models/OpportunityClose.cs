...
{
    public class OpportunityClose : DynamicsModel
    {
        ...
        [JsonProperty("competitoridname")]
        public string CompetitorIdName { get; set; }
        ...
        [JsonProperty("actualrevenue_base")]
        public string ActualRevenue_Base { get; set; }

        [JsonProperty("opportunityidtype")]
        public string OpportunityIdType { get; set; }

        [JsonProperty("competitoridyominame")]
        public string CompetitorIdYomiName { get; set; }
        ...
        [JsonProperty("opportunitystatuscodename")]
        public string opportunitystatuscodeName { get; set; }
