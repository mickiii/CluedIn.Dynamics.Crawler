...
{
    public class DataIngestion : IClassFixture<Dynamics365TestFixture>
    {
        private readonly Dynamics365TestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(Dynamics365TestFixture fixture, ITestOutputHelper output)
        {
